...
from Config.Functions.functions_cliente import Functions
...
class Screen_cadastro_cliente(Functions,Style):
    ...
    def config(self):
        ...
        self.root_cadastro_cliente.iconbitmap('Config\img\icon_cliente.ico')
    ...
    # --------------------------- button salvar ---------------------------------
        self.button_adicionar = Button(self.root_cadastro_cliente,text='Adicionar',font=self.font,background=self.collor_button,fg=self.font_color,command=self.salvar)
