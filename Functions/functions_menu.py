...
class Functions():
    ...
    def menu(self):
        ...
        self.opcoes.add_command(label='Cadastro de clientes', command=self.screen_cadastro_cliente)
        self.opcoes.add_command(label='Controle de clientes', command=self.screen_controle_cliente)
